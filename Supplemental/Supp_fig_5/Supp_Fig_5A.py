...
def make_fig():
    ...
    fig.update_yaxes(range=[0, 1.2], tickfont_size=28, nticks=5)
    ...
    pio.write_html(fig, file=r'/path_to_output_save_folder/Supp_Fig_5A.html') #produces an interactive .html graph. You may want to comment out lines "autosize=False, width=some_number, height=some_number" in fig.update_layout to allow the size to be automatically made for this file.
    fig.write_image('/path_to_output_save_folder/Supp_Fig_5A.png', scale=8) #produces a high res .png image
    print("Finished!")
