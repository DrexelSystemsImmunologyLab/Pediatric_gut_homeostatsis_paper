...
# =============================================================================
# Mann-Whitney for all tissue pair medians Sykes agaisnt PPG    
# =============================================================================
def stats_test_Mann_Whitney(dist1, dist2):
    if len(dist1) > 0 and len(dist2) > 0:
        # current_patient = df['Median'].loc[(df['Tissues'] == tissue_pair) & (df['Node_min'] == node_min) & (df['Patient'] == patient)].tolist()[0]
        stat, p = mannwhitneyu(dist1, dist2)
        # print("Comparing {} to {} for {}".format(first_patient, patient, tissue_pair))
...
def get_statistics():
    ...
    pio.write_html(fig, file=r'/path_to_output_save_folder/Fig_6_statistics_Mann_Whitney.html') #Creates an .html file containing results of statistics
    print("Finished!")
