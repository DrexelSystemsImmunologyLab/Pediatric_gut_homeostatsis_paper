...
result.to_pickle(r"/path_to_sykes_children_data_folder/subjects.pkl")
...
result = pd.read_sql_query(query, sql_engine)
result.to_pickle(r"/path_to_sykes_children_data_folder/sequence_collapse.pkl")
...
result = pd.read_sql_query(query, sql_engine)
result.to_pickle(r"/path_to_sykes_children_data_folder/sample_metadata.pkl")
...
result = pd.read_sql_query(query, sql_engine)
result.to_pickle(r"/path_to_sykes_children_data_folder/sample_stats.pkl")
...
result = pd.read_sql_query(query, sql_engine)
result.to_pickle(r"/path_to_sykes_children_data_folder/samples.pkl")
...
result = pd.read_sql_query(query, sql_engine)
result.to_pickle(r"/path_to_sykes_children_data_folder/studies.pkl")
...
for subject_id in subjects_dict.keys():
    ...
    result = pd.read_sql_query(query, sql_engine)
    result.to_pickle(r"/path_to_sykes_children_data_folder/clones_table/{}_clones_table.pkl".format(subject_id))
...
for subject_id in subjects_dict.keys():
    ...
    query = "select * from sequences where subject_id = {} and clone_id IS NOT NULL".format(subject_id) #No need to download sequences that do not have a clone_id.
    result = pd.read_sql_query(query, sql_engine)
    result.to_pickle(r"/path_to_sykes_children_data_folder/sequences_table/{}_sequences_table.pkl".format(subject_id))
...
for subject_id in subjects_dict.keys():
    ...
    result = pd.read_sql_query(query, sql_engine)
    result.to_pickle(r"/path_to_sykes_children_data_folder/clone_stats/{}_clone_stats.pkl".format(subject_id))
...
for subject_id in subjects_dict.keys():
    ...
    subject_clone_stats = pd.read_pickle(r"/path_to_sykes_children_data_folder/clone_stats/{}_clone_stats.pkl".format(subject_id))
    ...
    result.to_pickle(r"/path_to_sykes_children_data_folder/selection_pressure/{}_selection_pressure.pkl".format(subject_id))          
