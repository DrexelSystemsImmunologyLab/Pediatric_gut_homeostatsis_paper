...
def load_data_pretransplant_version(patient_name, patient_ID):
    ...
    if patient_name in lp16_subjects_dict.values():
        ...
        df_of_trees = pd.read_pickle(r"/path_to_lp16_data_folder/clones_table/{}_clones_table.pkl".format(patient_ID))
...
nodes_with_most_freq_mutations_simple_method = calculate_trunk_length()   
